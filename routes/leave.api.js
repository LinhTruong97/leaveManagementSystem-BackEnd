...
/**
 * @route GET /leaves/admin/:requestId
 * @description Get a leave request
 * @access Login required, limit access role (admin office)
 */
router.get(
  "/admin/:requestId",
  authentication.loginRequired,
  ...
  leaveController.getSingleLeaveAdmin
);

/**
 * @route GET /leaves/manager/:requestId
 * @description Get a leave request
 * @access Login required, limit access role (manager)
 */
router.get(
  "/manager/:requestId",
  authentication.loginRequired,
  ...
  leaveController.getSingleLeaveManager
);
 ...
 * @body { categoryName, fromDate, fromType, toDate, toType, reason, document}
 * @access Login required
 */
router.post(
  "/",
  ...
  validators.validate([
    ...
    body("fromType")
      ...
      .isIn(["full", "half morning", "half afternoon"])
 ...
 * @body { fromDate, fromType, toDate, toType, reason, document}
...
router.put(
  ...
  validators.validate([
    ...
    body("fromType")
      ...
      .isIn(["full", "half morning", "half afternoon"])
      .withMessage("From type value is invalid"),
    body("toDate").optional().isISO8601().withMessage("To date wrong format"),
    body("toType")
      .optional()
      .isIn(["full", "half morning", "half afternoon"])
      .withMessage("To type value is invalid"),
